...
/**
 * @ExcelFIleReaderClass== this class provides reading excel data from the "TwitterAccountTestData.xlsx"
 * using APATCH POI API
 * 
 *
 */
public class readExcelData {
	...
	/**
	 * @Common DataProvider method for all test cases are bellow:
	 * @TestCaseName==ExcelSheetName
	 *
	 */
	...
	public Object[][] getData(Method m) throws Exception{
		...
		return data.readExcelData(System.getProperty("user.dir")+"\\src\\test\\resources\\ExcelData\\TwitterAccountTestData.xlsx", m.getName());
